...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            ...
            ann_file='data/sunrgbd_coda/reduced_train_ann.pkl',
    ...
    val=dict(
        ...
        ann_file='data/sunrgbd_coda/reduced_val_ann.pkl',
...
evaluation = dict(pipeline=test_pipeline, interval=1)
...
load_from ='./work_dirs/ovuni3detr_sunrgbd_pc_agn/latest.pth'
